...
The current bundled set is `python-pytest`, `node-npm-test`, `go-test`, `php-phpunit`, and
`ruby-rspec`. New adapters should have a real repository shape to match and should not be added
only to increase the adapter count.
